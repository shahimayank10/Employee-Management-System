...
const NewTask = ({data}) => {
  return (
    ...
    <h3 className='bg-red-500 rounded px-3 py-2 font-semibold text-white'>{data.category}</h3>
    <h2 className='font-medium text-md'>{data.taskDate}</h2> 
     ...
     <button className='mt-5 w-full p-2 text-white bg-green-500'>Accept Task</button>
   </div>
  )
}
